...
interface CreateFactorySaleOfficeFormProps {
    isVisible: boolean;
...
export default function CreateFactorySaleOfficeForm({ isVisible, saleOffices, factories, loadingMasterData, onClose, onSuccess, onStart, onError }: CreateFactorySaleOfficeFormProps) {
    const t = useTranslations('FactorySaleOffice.Form');
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/factory-sale-office`, {
                method: 'POST',
                headers: {
            ...
            console.error('Create factory sale office error:', err);
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                        <Label htmlFor="sale_office_id" className="text-sm text-gray-600">{t('saleOffice')} *</Label>
                        <Select
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="factory_id" className="text-sm text-gray-600">{t('factory')} *</Label>
                        <Select
