...
interface CreateShipToFormProps {
    isVisible: boolean;
    onClose: () => void;
    onSuccess: () => void;
    onStart?: () => void;
...
export default function CreateShipToForm({ isVisible, onClose, onSuccess, onStart, onError }: CreateShipToFormProps) {
    const t = useTranslations("ShipTos.CreateShipToForm");
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const submitData = {
                ...formData,
                sale_office_customer_id: formData.sale_office_customer_id ? Number(formData.sale_office_customer_id) : undefined,
                description: formData.description || undefined,
            };

            const res = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/ship-tos`, {
                method: 'POST',
                headers: {
            ...
            console.error('Create ship to error:', err);
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="text-xs text-gray-500">
                            {formData.ship_to_code.length}/50 {t("validation.maxLength")}
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <PaginatedSelect
                            value={formData.sale_office_customer_id}
                            ...
                            onValueChange={(value) => setFormData({ ...formData, sale_office_customer_id: value })}
                    ...
                    <div className="space-y-2 md:col-span-2">
                        ...
                        />
                        <div className="text-xs text-gray-500">
                            {formData.description.length}/200 {t("validation.maxLength")}
                        </div>
                    </div>
